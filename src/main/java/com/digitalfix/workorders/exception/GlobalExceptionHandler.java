...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(WorkOrderAccessDeniedException.class)
    public ResponseEntity<ErrorResponse> handleAccessDenied(WorkOrderAccessDeniedException ex, HttpServletRequest req) {
